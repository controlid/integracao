...
interface
  uses  Classes, Forms, dynlibs, dialogs, LCLType, Sysutils;
...
implementation
  ...
  begin
     ...
     path :=  path + 'libcidbio.' + SharedSuffix;    // dll ou so = multiplataforma
     MyLibC := LoadLibrary (path);
     ...
     CIDBIO_SetSerialCommPort := TCIDBIO_SetSerialCommPort(GetProcedureAddress(MyLibC, 'CIDBIO_SetSerialCommPort'));
     CIDBIO_Init := TCIDBIO_Init(GetProcedureAddress(MyLibC, 'CIDBIO_Init'));
     CIDBIO_Terminate := TCIDBIO_Terminate(GetProcedureAddress(MyLibC, 'CIDBIO_Terminate'));
     CIDBIO_CaptureImage := TCIDBIO_CaptureImage(GetProcedureAddress(MyLibC, 'CIDBIO_CaptureImage'));
     CIDBIO_CaptureImageAndTemplate := TCIDBIO_CaptureImageAndTemplate(GetProcedureAddress(MyLibC, 'CIDBIO_CaptureImageAndTemplate'));
     CIDBIO_CaptureAndEnroll := TCIDBIO_CaptureAndEnroll(GetProcedureAddress(MyLibC, 'CIDBIO_CaptureAndEnroll'));
     CIDBIO_CaptureAndIdentify := TCIDBIO_CaptureAndIdentify (GetProcedureAddress(MyLibC, 'CIDBIO_CaptureAndIdentify'));
     CIDBIO_CaptureAndMatch := TCIDBIO_CaptureAndMatch (GetProcedureAddress(MyLibC, 'CIDBIO_CaptureAndMatch'));
     CIDBIO_CheckFingerprint := TCIDBIO_CheckFingerprint (GetProcedureAddress(MyLibC, 'CIDBIO_CheckFingerprint'));
     CIDBIO_CancelCapture := TCIDBIO_CancelCapture (GetProcedureAddress(MyLibC, 'CIDBIO_CancelCapture'));
     CIDBIO_ExtractTemplateFromImage := TCIDBIO_ExtractTemplateFromImage (GetProcedureAddress(MyLibC, 'CIDBIO_ExtractTemplateFromImage'));
     CIDBIO_MergeTemplates := TCIDBIO_MergeTemplates (GetProcedureAddress(MyLibC, 'CIDBIO_MergeTemplates'));
     CIDBIO_MatchTemplates := TCIDBIO_MatchTemplates (GetProcedureAddress(MyLibC, 'CIDBIO_MatchTemplates'));
     CIDBIO_MatchTemplateByID := TCIDBIO_MatchTemplateByID (GetProcedureAddress(MyLibC, 'CIDBIO_MatchTemplateByID'));
     CIDBIO_GetTemplateIDs := TCIDBIO_GetTemplateIDs (GetProcedureAddress(MyLibC, 'CIDBIO_GetTemplateIDs'));
     CIDBIO_GetTemplate := TCIDBIO_GetTemplate (GetProcedureAddress(MyLibC, 'CIDBIO_GetTemplate'));
     CIDBIO_SaveTemplate := TCIDBIO_SaveTemplate (GetProcedureAddress(MyLibC, 'CIDBIO_SaveTemplate'));
     CIDBIO_DeleteTemplate := TCIDBIO_DeleteTemplate (GetProcedureAddress(MyLibC, 'CIDBIO_DeleteTemplate'));
     CIDBIO_DeleteAllTemplates := TCIDBIO_DeleteAllTemplates (GetProcedureAddress(MyLibC, 'CIDBIO_DeleteAllTemplates'));
     CIDBIO_SetParameter := TCIDBIO_SetParameter (GetProcedureAddress(MyLibC, 'CIDBIO_SetParameter'));
     CIDBIO_GetParameter := TCIDBIO_GetParameter (GetProcedureAddress(MyLibC, 'CIDBIO_GetParameter'));
     CIDBIO_GetDeviceInfo := TCIDBIO_GetDeviceInfo (GetProcedureAddress(MyLibC, 'CIDBIO_GetDeviceInfo'));
     CIDBIO_UpdateFirmware := TCIDBIO_UpdateFirmware (GetProcedureAddress(MyLibC, 'CIDBIO_UpdateFirmware'));
     CIDBIO_GetErrorMessage := TCIDBIO_GetErrorMessage (GetProcedureAddress(MyLibC, 'CIDBIO_GetErrorMessage'));
     CIDBIO_FreeString := TCIDBIO_FreeString (GetProcedureAddress(MyLibC, 'CIDBIO_FreeString'));
     CIDBIO_FreeByteArray := TCIDBIO_FreeByteArray (GetProcedureAddress(MyLibC, 'CIDBIO_FreeByteArray'));
     CIDBIO_FreeIDArray := TCIDBIO_FreeIDArray (GetProcedureAddress(MyLibC, 'CIDBIO_FreeIDArray'));
  end;
