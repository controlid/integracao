...
interface
  ...
  Function CIDBIO_SetSerialCommPort(commPort : PAnsiChar): Int32 StdCall; External 'libcidbio.dll';
  Function CIDBIO_Init: Int32 StdCall; External 'libcidbio.dll';
  Function CIDBIO_Terminate: Int32 StdCall; External 'libcidbio.dll';

  Function CIDBIO_CaptureImage(Out imageBuf : PByte; Out width : Int32; Out height : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_CaptureImageAndTemplate(Out t : PAnsiChar; Out imageBuf : PByte; Out width : Int32; Out height : Int32; Out quality : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_CaptureAndEnroll(id : Int64): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_CaptureAndIdentify(Out id : Int64; Out score : Int32; Out quality : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_CaptureAndMatch(id : Int64; Out score : Int32; Out quality : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_CheckFingerprint(Out imageBuf : PByte; Out width : Int32; Out height : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_CancelCapture: Int32; cdecl; External 'libcidbio.dll';

  Function CIDBIO_ExtractTemplateFromImage(width : Int32; height : Int32; imageBuf : PByte; Out t : PAnsiChar; Out quality : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_MergeTemplates(t1 : PAnsiChar; t2 : PAnsiChar; t3 : PAnsiChar; Out tFinal : PAnsiChar): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_MatchTemplates(t1 : PAnsiChar; t2 : PAnsiChar; Out score : Int32): Int32; cdecl; External 'libcidbio.dll';
  Function CIDBIO_MatchTemplateByID(id : Int64; t : PAnsiChar; Out score : Int32): Int32; cdecl; External 'libcidbio.dll';
  ...
  Function CIDBIO_GetDeviceInfo(Out version : PAnsiChar; Out serialNumber : PAnsiChar; Out model : PAnsiChar): Int32; cdecl; External 'libcidbio.dll';
...
Type
  ...
  CIDBio = Class(TObject)
    Public
      Class Function SetSerialCommPort(commPort : String): RetCode; Static;
      ...
      Function CaptureImageAndTemplate(Out t : String ; Out imageBuf : ByteArray; out width, height, quality : Integer): RetCode;
      ...
      Function ExtractTemplateFromImage(width, height : Integer; image : ByteArray; Out t : String; Out quality : Integer): RetCode;
...
implementation
  ...
  Class Function CIDBio.SetSerialCommPort(commPort : String) : RetCode;
  begin
    result := RetCode(CIDBIO_SetSerialCommPort(PAnsiChar(AnsiString(commPort))));
  end;
